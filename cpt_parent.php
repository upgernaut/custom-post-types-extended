...
public function cpt_init() {
	...
	add_action( 'init', array($this,'news_for_event'));
	...
	$this->taxonomies['news_tax'] = array(
		"id" => "news_tax",
		"name" => "News"
	);
...
public function news_for_event() {
	register_taxonomy_for_object_type( 'news_tax', EM_POST_TYPE_EVENT );
}
...
<div class="wrap">
    <h2><span class="dashicons dashicons-admin-generic"></span>
        <?php echo $this->cpt_name; ?> settings</h2>
    <?php
    ...
    <form method="post" action="<?php admin_url( 'edit.php?post_type='.$this->cpt_id.'&page='.$this->cpt_id.'-page-content' ); ?>">
        <table class="form-table">
            ...
            <tr>
                <th><label for="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>">
                        <?php echo $option['title']; ?>:</label></th>
            ...
            <tr>
                <th><label for="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>_hy">
                        <?php echo $option['title']; ?> HY:</label></th>
                <td><input type="text" name="data[<?php echo $option['name']; ?>_hy]" id="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>_hy" class="regular-text" value="<?php echo $this->cpt_custom_content( $this->cpt_id, $option['name'] . '_hy'); ?>"></td>
            </tr>
            <?php elseif($option['type'] == 'textarea'): ?>
            <tr>
                <th><label for="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>">
                        <?php echo $option['title']; ?> EN:</label></th>
                <td><textarea rows="5" name="data[<?php echo $option['name']; ?>]" id="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>" class="regular-text"><?php echo $this->cpt_custom_content( $this->cpt_id, $option['name']); ?></textarea></td>
            </tr>
            <tr>
                <th><label for="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>_hy">
                        <?php echo $option['title']; ?> HY:</label></th>
                <td><textarea rows="5" name="data[<?php echo $option['name']; ?>_hy]" id="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>_hy" class="regular-text"><?php echo $this->cpt_custom_content( $this->cpt_id, $option['name'] . '_hy'); ?></textarea></td>
            </tr>
            ...
            <tr>
                <th><label for="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>">
                        <?php echo $option['title']; ?>:</label></th>
                <td>
                    <?php wp_editor( $this->cpt_custom_content( $this->cpt_id, $option['name'] ), $this->cpt_id . '_' .$option['name'], $settings = array("wpautop" => false,'textarea_name' => 'data['.$option['name'].']', 'textarea_rows'=>5) );  ?>
                </td>
            </tr>
            <tr>
                <th><label for="<?php echo $this->cpt_id; ?>_<?php echo $option['name']; ?>_hy">
                        <?php echo $option['title']; ?> HY:</label></th>
                <td>
                    <?php wp_editor( $this->cpt_custom_content( $this->cpt_id, $option['name'] .'_hy' ), $this->cpt_id . '_' .$option['name'] . '_hy', $settings = array("wpautop" => false,'textarea_name' => 'data['.$option['name'].'_hy]', 'textarea_rows'=>5) );  ?>
                </td>
            </tr>
            <?php endif; ?>
            <?php endforeach;?>
